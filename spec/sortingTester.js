...
describe('sorting functions', function () {
  ...
  describe('quick sort', function() {
    ...
    // quick sort is not stable with my current implementation
  });
  ...
  describe('radix sort', function() {
    ...
    it('exists', function() {
      expect(algorithms.radixSort).to.be.a('function');
    });

    it('sorts correctly', function() {
      var sortedArray = algorithms.radixSort(unsortedArray);
      expect(sortedArray).to.eql([2,2,5,7,9,9,12,51]);
    });
  ...
  describe('BST sort', function() {
    ...
    it('exists', function() {
      expect(algorithms.binarySearchSort).to.be.a('function');
    });

    it('sorts correctly', function() {
      var sortedArray = algorithms.binarySearchSort(unsortedArray);
      expect(sortedArray).to.eql([2,2,5,7,9,9,12,51]);
    });
